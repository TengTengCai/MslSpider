...
class IslamqaSpider(CrawlSpider):
    ...
    rules = (
        ...
        Rule(LinkExtractor(allow=r'https://islamqa.info/ar/categories/topics/\d+/.*?'), callback='parse_new_page',
             follow=True),
        Rule(LinkExtractor(allow=r'https://islamqa.info/zh/categories/topics/\d+/.*?'), callback='parse_new_page',
             follow=True),
    )
